...
function make_behaviour_gvf(behaviour_learner, discount, fc, exploration_strategy)
    ...
    BehaviourGVF = GVF(GVFParamFuncs.RewardCumulant(),discount, GVF_policy)
    return BehaviourGVF
end

function main_experiment(;progress=true)
    # Learn the policy
    seed = 1029
    Random.seed!(seed)

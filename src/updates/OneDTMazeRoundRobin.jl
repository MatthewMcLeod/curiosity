...
struct OneDTMazeRoundRobin <: LearningUpdate end

update!(self::OneDTMazeRoundRobin, args...) = nothing
Base.size(learner::OneDTMazeRoundRobin) = (0,0)

function get_action_probs(self::OneDTMazeRoundRobin, state, observation, args...)

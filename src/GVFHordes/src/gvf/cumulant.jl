...
Base.get(cumulant::FeatureCumulant; kwargs...) =
        kwargs[:state_tp1][cumulant.idx]
...
Base.get(cumulant::FunctionalCumulant; kwargs...) =
    cumulant.f(;kwargs...)


struct RewardCumulant <: AbstractCumulant end

# Base.get(cumulant::RewardCumulant; kwargs...) = @show kwargs, kwargs[:reward]
Base.get(cumulant::RewardCumulant; kwargs...) = kwargs[:reward]

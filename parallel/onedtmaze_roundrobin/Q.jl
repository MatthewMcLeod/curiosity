...
#SBATCH -o onedtmaze_RR_Q.out # Standard output
#SBATCH -e onedtmaze_RR_Q.err # Standard error
...
reproduce_config_experiment("configs/revised_onedtmaze/RoundRobin_Q.toml", save_path="~/scratch/curiosity")

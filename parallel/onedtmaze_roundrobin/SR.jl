...
#SBATCH -o onedtmaze_RR_SR.out # Standard output
#SBATCH -e onedtmaze_RR_SR.err # Standard error
...
reproduce_config_experiment("configs/revised_onedtmaze/RoundRobin_SR.toml", save_path="~/scratch/curiosity")

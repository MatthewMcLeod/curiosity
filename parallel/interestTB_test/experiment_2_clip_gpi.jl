...
#SBATCH -o experiment_2_clip_gpi.out # Standard output
#SBATCH -e experiment_2_clip_gpi.err # Standard error
...
reproduce_config_experiment("configs/interestTB_test/experiment_2_clip_gpi.toml", save_path="~/scratch/curiosity")

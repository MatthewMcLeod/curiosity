...
#SBATCH -o experiment_4_esarsa.out # Standard output
#SBATCH -e experiment_4_gpi.err # Standard error
...
reproduce_config_experiment("configs/interestTB_test/experiment_4_esarsa.toml", save_path="~/scratch/curiosity")

...
#SBATCH -o twodgridworld_esarsa.out # Standard output
#SBATCH -e twodgridworld_esarsa.err # Standard error
...
reproduce_config_experiment("configs/interestTB_test/twodgridworld_esarsa.toml", save_path="~/scratch/curiosity")

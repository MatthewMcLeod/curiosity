...
#SBATCH -o experiment_2_clip_esarsa.out # Standard output
#SBATCH -e experiment_2_clip_esarsa.err # Standard error
...
reproduce_config_experiment("configs/interestTB_test/experiment_2_clip_esarsa.toml", save_path="~/scratch/curiosity")

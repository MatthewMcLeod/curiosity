...
#SBATCH -o twodgridworld_rr_tb.out # Standard output
#SBATCH -e twodgridworld_rr_tb.err # Standard error
...
reproduce_config_experiment("configs/interestTB_test/twodgridworld_rr_tb.toml", save_path="~/scratch/curiosity")

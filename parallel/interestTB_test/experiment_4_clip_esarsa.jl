...
#SBATCH -o experiment_4_clip_esarsa.out # Standard output
#SBATCH -e experiment_4_clip_esarsa.err # Standard error
...
reproduce_config_experiment("configs/interestTB_test/experiment_4_clip_esarsa.toml", save_path="~/scratch/curiosity")

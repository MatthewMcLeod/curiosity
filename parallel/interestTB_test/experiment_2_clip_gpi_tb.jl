...
#SBATCH -o experiment_2_clip_gpi_tb.out # Standard output
#SBATCH -e experiment_2_clip_gpi_tb.err # Standard error
...
reproduce_config_experiment("configs/interestTB_test/experiment_2_clip_gpi_tb.toml", save_path="~/scratch/curiosity")

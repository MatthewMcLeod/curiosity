...
#SBATCH -o experiment_2_low_esarsa.out # Standard output
#SBATCH -e experiment_2_low_esarsa.err # Standard error
...
reproduce_config_experiment("configs/experiment_2/experiment_2_esarsa.toml", save_path="~/scratch/curiosity")
